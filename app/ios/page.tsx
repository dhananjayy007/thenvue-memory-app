    ...
    <div className="ios-page-wrapper">
      ...
      <main className="ios-main-content">
        ...
        <div className="ios-pill-badge">
          ...
          <span>iOS & iPadOS Experience</span>
        ...
        <p className="ios-hero-sub">
          We are polishing our native iOS app with fluid 120Hz gestures, Lock Screen widgets,
          iCloud photo rediscovery, and on-device AI memory recall.
        </p>
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="ios-waitlist-form">
              <div className="ios-form-header">
                ...
                <div>
                  ...
                  <p className="ios-form-desc">Be the first to test Thenvue on iPhone before our App Store release.</p>
                </div>
              </div>
            ...
            <div className="ios-success-state">
              ...
              <p className="ios-success-desc">
                We'll email <strong style={{ color: '#E3A07C' }}>{email}</strong> with an exclusive TestFlight invitation as soon as the iOS beta builds are ready.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="ios-features-grid">
          <div className="ios-feature-card">
            ...
            <p className="ios-feat-text">Crafted for iOS 18 with rich haptics, dark mode aesthetics, and seamless swipe navigation.</p>
          </div>
          ...
          <div className="ios-feature-card">
            ...
            <h4 className="ios-feat-title">Rediscover Past Photos</h4>
            <p className="ios-feat-text">Strict EXIF date extraction keeps every historical memory accurately placed on your timeline.</p>
          </div>
          ...
          <div className="ios-feature-card">
            ...
            <p className="ios-feat-text">Speak freely — Thenvue transcribes and connects your spoken thoughts automatically.</p>
          </div>
          ...
          <div className="ios-feature-card">
            ...
            <h4 className="ios-feat-title">Biometric Privacy</h4>
            <p className="ios-feat-text">Keep your private memories safe behind Face ID, Touch ID, and row-level security.</p>
          </div>
        </div>
