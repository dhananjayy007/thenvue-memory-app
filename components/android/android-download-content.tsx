...
export function AndroidDownloadContent() {
    ...
    <div className="android-page-wrapper">
      ...
      <main className="android-main-content">
        ...
        <p className="android-hero-sub">
          Install the native Android build directly on your phone or tablet. Experience past photo rediscovery, voice reflections, and private memory journaling.
        </p>
        ...
        <div className="android-download-card">
          ...
          <div className="android-steps-guide">
            ...
            <div className="android-step-row">
              ...
              <div className="step-content">
                <strong>Allow &ldquo;Install Unknown Apps&rdquo;</strong>
        ...
        <div className="android-features-grid">
          <div className="android-feature-card">
            ...
            <p className="android-feat-text">Material design elements, smooth animations, and clean memory views.</p>
          </div>
          ...
          <div className="android-feature-card">
            ...
            <p className="android-feat-text">Import past photos with date preservation to build your chronological timeline.</p>
          </div>
          ...
          <div className="android-feature-card">
            ...
            <p className="android-feat-text">Record spoken thoughts with speech-to-text transcription.</p>
          </div>
